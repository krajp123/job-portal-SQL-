...
router.delete('/moderation/reports/:id', requireSuperAdmin, jobModerationController.deleteReport);
router.patch('/moderation/support-reports/:id', requireSuperAdmin, jobModerationController.reviewHelpCenterReport);
router.delete('/moderation/support-reports/:id', requireSuperAdmin, jobModerationController.deleteHelpCenterReport);
